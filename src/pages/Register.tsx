...
import { IonContent, IonToast, IonPage, IonToolbar, IonAvatar, IonInput, IonButton, IonText, IonLoading, IonItem, IonIcon, useIonViewDidLeave, useIonViewWillLeave, useIonViewDidEnter } from '@ionic/react';
import './Register.css';
...
const Register: React.FC = () => {
  ...
  const register = async () => {
    ...
    let User = await auth.createUserWithEmailAndPassword(emailaddress, password).then(async (authUser) => {
      return authUser
